...
/**
 * create_xarray - create array of chars and initialize it with
 * the character 'x'. adds terminating null byte
...
/**
 * iterate_zeroes - iterates through string of numbers containing
 * leading zeroes until it hits non zero number
